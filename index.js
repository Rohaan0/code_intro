...
var total = Netflix + Hulu + Disney + Youtube_Premium + Peacock;
console.log("The total of all of the subscriptions is $" + total)
...
// CODE HERE
var Hulu = Hulu - Hulu;
var Peacock = Peacock - 5;
var Netflix = Netflix - 7;
...
console.log("The new total of the subscriptions is $"+newTotal)
...
console.log("Your discount was "+(Math.round(savings))+"%");